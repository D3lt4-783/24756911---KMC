...
3. Is the full control loop of the project. Responsible for the control of the motor drivers of the pump and stepper motors. As well as the User interface.
4. 
